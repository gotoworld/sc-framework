...
@RestController
@Slf4j
public class MemPanoCategoryController extends BaseController {
	@Autowired
	protected ISysCategoryService sysCategoryService;
	
	private static final String acPrefix="/api/m/pano/category/";
	private static final String init = "member/pano/pano_category";
	private static final String edit = "member/pano/pano_category_edit";
	private static final String list = "member/pano/pano_category_list";
	private static final String success = "redirect:"+acPrefix+"init";
	
	/**
	 * <p> 初始化处理。
	 */
	@RequiresPermissions("memCategory:menu")
	...
	public Response jsonTree() {
		log.info("PanoCategoryController jsonTree.........");
	...
	public String page(HttpServletRequest request, HttpServletResponse response,SysCategory dto) {
		log.info("PanoCategoryController page.........");
        Response result = new Response();
		try {
            if(dto==null){
                dto = new SysCategory();
	 ...
	 * <p> 编辑。
	 */
	@RequiresPermissions("memCategory:edit")
	 ...
	 * <li>删除。
	 */
	@RequiresPermissions("memCategory:del")
	 ...
	 * <p> 信息保存
	 */
	@RequiresPermissions(value={"memCategory:add","memCategory:edit"},logical=Logical.OR)
