...
@Component
@Slf4j
public class RfAccount2BeanXAspect {
    //切点
    @Pointcut("@annotation(com.hsd.framework.annotation.RfAccount2BeanX)")
    public void account2BeanXAspect() {
    }

    /**
     * 用于 将当前操作人员的信息写入实体对象
     */
    @Before("account2BeanXAspect()")
