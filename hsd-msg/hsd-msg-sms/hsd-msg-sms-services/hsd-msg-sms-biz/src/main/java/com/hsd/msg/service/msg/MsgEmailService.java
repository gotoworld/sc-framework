...
import com.hsd.msg.dao.msg.IMsgEmailDao;
import com.hsd.msg.dto.msg.MsgEmailDto;
import com.hsd.msg.entity.msg.MsgEmail;
...
public class MsgEmailService extends BaseService implements IMsgEmailService {
    ...
    @Override
    public PageInfo findDataIsPage(@RequestBody MsgEmailDto dto) {
    ...
    @Override
    public MsgEmailDto findDataById(@RequestBody MsgEmailDto dto) {
