...
//				console.log("js生成当前scene图片："+hname);
				krpano.call("addhotspot("+hname+");set(hotspot["+hname+"].url,"+url+");set(hotspot["+hname+"].ath,"+ath+");set(hotspot["+hname+"].atv,"+atv+");set(hotspot["+hname+"].rotate,"+rotate+");set(hotspot["+hname+"].scale,"+scale+");set(hotspot["+hname+"].distorted,true);set(hotspot["+hname+"].depth,"+depth+");set(hotspot["+hname+"].onclick,remove_picspots());");
			}
		}
	}
}
