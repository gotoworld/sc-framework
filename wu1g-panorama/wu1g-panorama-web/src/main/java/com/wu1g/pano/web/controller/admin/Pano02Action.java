 ...
 */
@Controller
public class Pano02Action extends BaseAction {
	private static final long				serialVersionUID	= -528422099490438672L;
	private static final transient Logger	log					= Logger.getLogger( Pano02Action.class );
	/** 全景_项目 业务处理 */
	@Autowired
	...
	// 全景_项目
	private static final String				acPrefix			= "/h/pano02.";
	private static final String				init				= "admin/pano/pano02";
	private static final String				edit				= "admin/pano/pano02_edit";
	private static final String				list				= "admin/pano/pano02_list";
