	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#menu_sys,#menu_sys_sub_3').addClass('active');
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							系统_数据字典管理 <small><span class="help-inline">在这里你可以查看未删除的信息</span></small>
						</h3>
						<ul class="page-breadcrumb breadcrumb">
							
							<li><a href="${basePath}/h/sys03.init">系统_数据字典管理</a> <i class="fa fa-angle-right"></i></li>
							<li>列表</li>
						</ul>
					...
					<div class="col-md-12">
						<div class="matter">
							...
							<div class="form-actions">
								<form id="info_search_form" method="post" class="form-horizontal" accept-charset="UTF-8" action="${basePath}/h/sys03.infoList">
							...
							<a href="javascript:;" onclick="openMyBoxLayer('a','${basePath}/h/sys03.edit')" class="label label-primary"><i class="fa fa-plus"></i> 新增</a>
