...
<link rel="stylesheet" type="text/css" href="${basePath}/static/plugins/fuelux/css/tree-metronic.css" />
<style type="text/css">
</style>
</head>
<!-- END HEAD -->
	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#menu_sys,#menu_org_sub_1').addClass('active');
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							组织架构_部门管理 <small><span class="help-inline">在这里你可以查看未删除的信息</span></small>
						</h3>
						<ul class="page-breadcrumb breadcrumb">
							
							<li><a href="${basePath}/h/org01.init">组织架构_部门管理</a> <i class="fa fa-angle-right"></i></li>
							<li>列表</li>
						</ul>
															...
															<div class="tree-folder-name">
																...
																<div class="tree-actions">
																	<shiro:hasPermission name="orgDept:edit">
																		<a style="display: block; float: left;" href="javascript:;" onclick="openMyBoxLayer('e','${basePath}/h/org01.edit/${b.id}');" class="label label-success"> <i class="fa fa-pencil"></i>
																		</a>
																	</shiro:hasPermission>
																	<shiro:hasPermission name="orgDept:del">
																		<c:if test="${fn:length(b.beans)==0}">
																			<a href="javascript:;" onclick="if(confirm('确认删除吗?')){delInfoData('${basePath}/h/org01.del/${b.id}');};" rel="nofollow" class="label label-danger"> <i class="fa fa-trash-o"></i>
																			</a>
																		</c:if>
																	</shiro:hasPermission>
																</div>
