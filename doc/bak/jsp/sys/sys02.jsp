	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#menu_sys,#menu_sys_sub_2').addClass('active');
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							系统_管理员操作日志管理 <small><span class="help-inline">在这里你可以查看未删除的信息</span></small>
						</h3>
						<ul class="page-breadcrumb breadcrumb">
							
							<li><a href="${basePath}/h/sys02.init">系统_管理员操作日志管理</a> <i class="fa fa-angle-right"></i></li>
							<li>列表</li>
						</ul>
								...
								<form id="info_search_form" method="post" class="form-horizontal" accept-charset="UTF-8" action="${basePath}/h/sys02.infoList">
									...
									<div class="row clearfix">
										<div class="input-group col-xs-12 col-sm-6 col-md-4 col-lg-3 mt10">
											<span class="input-group-addon"> 内容 </span> <input x_placeholder="内容" class="form-control" name="description" value="${bean.description}" type="text">
										</div>
										<div class="input-group col-xs-12 col-sm-6 col-md-4 col-lg-3 mt10">
