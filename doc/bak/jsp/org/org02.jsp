	...
	<div class="page-container">
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {
				$('#menu_sys,#menu_org_sub_2').addClass('active');
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							组织架构_用户管理 <small><span class="help-inline">在这里你可以查看未删除的信息</span></small>
						</h3>
					...
					<div class="col-md-12">
						<div class="matter">
							...
							<div class="form-actions">
								<form id="info_search_form" method="post" class="form-horizontal" accept-charset="UTF-8" action="${basePath}/h/org02.infoList">
									<input type="hidden" name="pageNum" id="pageNumA" value="${bean.pageNum}">
									<div class="row clearfix">
										<div class="input-group col-xs-12 col-sm-6 col-md-2 mt10">
											<span class="input-group-addon"> 姓名 </span> <input x_placeholder="用户名称" class="form-control" name="name" value="" type="text">
										</div>
										<div class="input-group col-xs-12 col-sm-6 col-md-2 mt10">
											<span class="input-group-addon"> 角色 </span> <input x_placeholder="角色名称" class="form-control" name="roleNames" value="" type="text">
										</div>
										<div class="input-group col-xs-12 col-sm-6 col-md-3 mt10">
							...
							<shiro:hasPermission name="orgUser:add">
								<a href="javascript:;" onclick="openMyBoxLayer('a','${basePath}/h/org02.edit/null')" class="label label-primary"> <i class="fa fa-plus"></i> 新增
								</a>
							</shiro:hasPermission>
