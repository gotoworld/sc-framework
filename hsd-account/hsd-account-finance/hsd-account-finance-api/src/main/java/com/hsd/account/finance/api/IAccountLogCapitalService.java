...
public interface IAccountLogCapitalService {
    ...
    Response saveOrUpdateData(AccountLogCapitalDto dto) throws Exception;
    ...
    PageInfo findDataIsPage(AccountLogCapitalDto dto) throws Exception;

    /**
     * <p>信息列表。
     */
    @RequestMapping(method = {RequestMethod.POST},value = acPrefix + "/findDataIsList")
    List<AccountLogCapitalDto> findDataIsList(AccountLogCapitalDto dto) throws Exception;
    ...
    AccountLogCapitalDto findDataById(AccountLogCapitalDto dto) throws Exception;
}