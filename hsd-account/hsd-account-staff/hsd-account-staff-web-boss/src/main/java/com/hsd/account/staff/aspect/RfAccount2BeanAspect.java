...
public class RfAccount2BeanAspect {
    ...
    public void doBefore(JoinPoint joinPoint) throws Exception {
        ...
        //读取session中的员工
        OrgStaffDto orgStaffDto = JwtUtil.getSubject(OrgStaffDto.class);
        //请求的IP
        ...
        try {
            if(log.isDebugEnabled()) {
                ...
                log.debug("请求人:" + orgStaffDto.getName());
                log.debug("请求IP:" + ip);
            }
...
//                      System.out.printf(JSON.toJSONString(obj));
                        ReflectUtil.setValueByFieldName2(obj,"createId", orgStaffDto.getId());//创建者id
                        ReflectUtil.setValueByFieldName2(obj,"appUserId", orgStaffDto.getAppUserId());//app用户id
                        ReflectUtil.setValueByFieldName2(obj,"appId", orgStaffDto.getAppId());//appId
                        ReflectUtil.setValueByFieldName2(obj,"appName", orgStaffDto.getAppName());//app名称
                        ReflectUtil.setValueByFieldName2(obj,"account", orgStaffDto.getAccount());//id
