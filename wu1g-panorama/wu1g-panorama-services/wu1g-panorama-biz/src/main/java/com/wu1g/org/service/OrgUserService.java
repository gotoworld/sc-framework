...
import cn.com.baseos.bean.auth.AuthUserVsRole;
import cn.com.baseos.bean.org.OrgDepartment;
import cn.com.baseos.bean.org.OrgUser;
import cn.com.baseos.bean.org.OrgUserVsDepartment;
import cn.com.baseos.common.ClassReflectionUtil;
...
import cn.com.baseos.dao.daointer.auth.IAuthUserVsRoleDao;
import cn.com.baseos.dao.daointer.org.IOrgDepartmentDao;
import cn.com.baseos.dao.daointer.org.IOrgUserDao;
import cn.com.baseos.dao.daointer.org.IOrgUserVsDepartmentDao;
import cn.com.baseos.service.BaseService;
import cn.com.baseos.service.org.IOrgUserService;
...
public class OrgUserService extends BaseService implements IOrgUserService {
	...
	private static final transient Logger	log	= Logger.getLogger( OrgUserService.class );
	/** 组织架构_用户 Dao接口类 */
	@Autowired
