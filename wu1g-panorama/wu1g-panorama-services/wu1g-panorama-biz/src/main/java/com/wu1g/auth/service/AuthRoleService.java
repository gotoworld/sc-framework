...
import cn.com.baseos.bean.auth.AuthRoleVsPerm;
...
import cn.com.baseos.dao.daointer.auth.IAuthRoleVsPermDao;
...
public class AuthRoleService extends BaseService implements IAuthRoleService {
	...
	private static final transient Logger	log	= Logger.getLogger( AuthRoleService.class );
	/** 权限_角色信息 Dao接口类 */
	@Autowired
