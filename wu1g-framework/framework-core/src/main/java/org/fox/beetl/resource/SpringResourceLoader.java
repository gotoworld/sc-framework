package org.fox.beetl.resource;
...
public class SpringResourceLoader implements ResourceLoader, ApplicationContextAware {
     ...
     * 资源文件字符编码，默认取上下文默认编码
     *
     * @param charset 资源文件字符编码，默认取上下文默认编码
     */
     ...
     *
     * @param functionRootResource 函数定义文件目录，默认为classpath下functions目录
     */
     ...
     * 函数定义文件后缀名，默认fn
     *
     * @param functionSuffix 函数定义文件后缀名，默认fn
     */
     ...
     * 资源前缀名，仅对以/开头的资源id有效
     *
     * @param prefix 资源前缀名，仅对以/开头的资源id有效
     */
