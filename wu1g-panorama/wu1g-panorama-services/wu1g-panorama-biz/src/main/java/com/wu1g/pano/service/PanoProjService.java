...
import cn.com.baseos.common.BeetlUtils;
...
import cn.com.baseos.common.cmdprocessor.KrPanoUtil;
import cn.com.baseos.dao.daointer.pano.IPanoMapDao;
import cn.com.baseos.dao.daointer.pano.IPanoProjDao;
import cn.com.baseos.dao.daointer.pano.IPanoSceneDao;
...
public class PanoProjService   extends BaseService  implements IPanoProjService{
	private static final transient Logger log = Logger.getLogger(PanoProjService.class);
	@Autowired
