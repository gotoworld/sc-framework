...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="row">
			<div class="col-md-12">
				<form id="org01_01" method="post" class="form-horizontal"  target="_top" accept-charset="UTF-8"  action="${basePath}/h/org01.save">
				  <input type="hidden" name="pageNum" id="bean_pageNum" value="${bean.pageNum}">
				  <input type="hidden" name="id" value="${bean.id}" />
					<div class="form-group">
					  <label class="col-md-2 control-label" for="bean_parentid">上级部门</label>
					  <div class="col-md-4">
					  		...
					  		<select  class="form-control" name="parentid">
					  			...
					  			<c:if test="${beans!=null && fn:length(beans)>0}">
					  				<c:forEach items="${beans}" var="b" varStatus="i">
					  					...
					  					<c:import url="org01_r_select.jsp" />
					  					</c:if>
					  				</c:forEach>
					  			</c:if>
					  		</select>
