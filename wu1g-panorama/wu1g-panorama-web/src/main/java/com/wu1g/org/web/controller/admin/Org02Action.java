...
import cn.com.baseos.service.org.IOrgDepartmentService;
...
public class Org02Action extends BaseAction{

	private static final long serialVersionUID = -847589285730427889L;
	private static final transient Logger log = Logger.getLogger(Org02Action.class);
	/**组织架构_用户 业务处理*/
	@Autowired
